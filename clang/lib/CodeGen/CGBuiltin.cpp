...
Value *CodeGenFunction::EmitWebAssemblyBuiltinExpr(unsigned BuiltinID,
  ...
  case WebAssembly::BI__builtin_wasm_segment_new: {
    Function *Callee = CGM.getIntrinsic(Intrinsic::wasm_segment_new);
    Value *Ptr = EmitScalarExpr(E->getArg(0));
  ...
  case WebAssembly::BI__builtin_wasm_untag_ptr: {
    ...
    Value *BitMask = llvm::ConstantInt::get(IntTy, 0xF0FF'FFFF'FFFF'FFFF, false);
  ...
  case WebAssembly::BI__builtin_wasm_tag_ptr: {
    llvm::Type *IntTy = llvm::Type::getInt64Ty(Builder.getContext());
    Value *Ptr = EmitScalarExpr(E->getArg(0));
    Value *Tag = EmitScalarExpr(E->getArg(1));
    ...
    Value *BitMask = llvm::ConstantInt::get(IntTy, 0xF0FF'FFFF'FFFF'FFFF, false);
    Value *BitMaskTag = llvm::ConstantInt::get(IntTy, 0x0F00'0000'0000'0000, false);
    ...
    return Builder.CreateIntToPtr(TaggedPtr, ConvertType(E->getType()));
  }
