...
void perform_merge(void** arr, void** const L, void** const R, size_t l, size_t n1, size_t n2) {
    size_t i = 0, j = 0, k = l;
...
void merge(void** arr, size_t l, size_t m, size_t r) {
    ...
    // For small partition sizes, allocate constant size on the stack to take advantage of our optimizations
    if (L_size <= LIMIT && R_size <= LIMIT) {
        void* L[LIMIT], *R[LIMIT];
...
void modified_merge_sort(void** arr, size_t l, size_t r) {
    if (l < r) {
        size_t m = l + (r - l) / 2;
