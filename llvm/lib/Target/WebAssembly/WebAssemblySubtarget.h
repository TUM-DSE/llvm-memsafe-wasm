...
public:
  ...
  bool hasAddr64() const { return this->hasMemSafety() || TargetTriple.isArch64Bit(); }
  ...
  bool hasMemSafety() const { return true; } // TODO(martin): change this back to HasMemSafety
